...
pub const MIN_SENSOR_READINGS_BEFORE_SLEEP: u64 = 2;
...
pub const DEEP_SLEEP_DURATION_SECONDS: u64 =
    3600 - (MIN_SENSOR_READINGS_BEFORE_SLEEP * MEASUREMENT_INTERVAL_SECONDS);
